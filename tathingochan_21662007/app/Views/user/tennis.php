...
<body>
    ...
    <div class="hero_banner">
        <img src="<?= base_url('asset_user/images/banner_tennis.jpg') ?>" class="img-fluid" alt="Hero Image">
    </div>
    <!-- End Hero Section -->
  ...
  <form action="<?= base_url('tennis/search') ?>" method="post">
  <?= csrf_field() ?>
