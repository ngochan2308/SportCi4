...
<body>
    ...
    <div class="hero_banner">
        <img src="<?= base_url('asset_user/images/banner_run.jpg') ?>" class="img-fluid" alt="Hero Image">
    </div>
    <!-- End Hero Section -->
    ...
    <form action="<?= base_url('running/search') ?>" method="post">
    <?= csrf_field() ?>
