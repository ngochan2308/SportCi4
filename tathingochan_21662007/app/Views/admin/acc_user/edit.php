    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h6 class="mb-4">Chỉnh sửa tài khoản khách hàng</h6>
                
                <form action="<?= base_url('admin/acc_user/update/' . $account['id']) ?>" method="post" enctype="multipart/form-data">
                ...
                <?php endif; ?>
                    ...
                    <div class="mb-3">
                        <label for="maTaiKhoan" class="form-label">Chọn quyền:</label>
                        <select class="form-select short-input" id="maTaiKhoan" name="MaTaiKhoan">
                            <option value="1" <?= ($account['MaTaiKhoan'] == 1) ? 'selected' : '' ?>>Quyền 1 (Admin)</option>
                            <option value="2" <?= ($account['MaTaiKhoan'] == 2) ? 'selected' : '' ?>>Quyền 2 (User)</option>
                        </select>
                    </div>
